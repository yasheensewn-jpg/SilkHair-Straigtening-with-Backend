    ...
    return (
        <Card className="p-4 sm:p-6 h-full flex flex-col">
             ...
             <div className="space-y-6 flex-1 overflow-y-auto">
                <div>
                    <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">Appointments</h4>
                    {bookings.length > 0 ? (
                        ...
                        <div className="py-8 text-center bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                            <p className="text-xs text-gray-400 font-bold">No appointments for this day</p>
                        </div>
                    )}
                </div>
                 <div>
                    <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">Pre-set Availability</h4>
                    {availabilityRanges.length > 0 ? (
                        ...
                        <div className="py-4 text-center">
                            <p className="text-[10px] text-gray-400 font-bold italic">No specific hours defined</p>
                        </div>
                    )}
                </div>
             </div>
